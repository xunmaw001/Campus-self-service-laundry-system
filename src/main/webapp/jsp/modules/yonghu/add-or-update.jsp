                        ...
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                   ...
                                   <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>余额</label>
                                        <input id="money" name="money" value="0" class="form-control"
                                               onchange="moneyChickValue(this)"  placeholder="余额">
                                    </div>
...
<script>
    ...
    function getDetails() {
        var id = window.sessionStorage.getItem("userID");
        if(id == null){
            id = window.sessionStorage.getItem("updateId");
        }
        if (id != null && id != "" && id != "null") {
            userID = id;
            window.sessionStorage.removeItem('userID');
